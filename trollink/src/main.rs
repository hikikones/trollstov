...
fn open_database(path: Option<PathBuf>) -> Result<Database, String> {
    fn get_default_database_file() -> Option<PathBuf> {
...
#[cfg(debug_assertions)]
fn open_dev_database(path: Option<PathBuf>) -> Result<Database, String> {
    if path.is_some() {
        open_database(path)
    } else {
...
fn get_or_create_assets_dir(path: Option<PathBuf>) -> Result<PathBuf, String> {
    fn get_default_assets_dir() -> Option<PathBuf> {
